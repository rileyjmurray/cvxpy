...
# of the sidebar.
# html_logo = 'assets/cvxpy_parabolas_light.png'
# html_logo = 'assets/CVXPY_Logo_CMYK_LightBG.png'
# html_logo = 'assets/cvxpy-logo-light-small-margins.png'
html_logo = 'assets/cvxpy-wordmark-light.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = 'assets/favicon_white_bg/android-chrome-192x192.png'
